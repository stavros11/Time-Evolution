...
""""TFIMTrotter class tests"""
#mps = mps_trotter.TFIMTrotter(exact_state[0], d_bond, dt, h=h_ev)
...
""""TFIM_TEBD class tests"""
mps = mps_trotter.TFIM_TEBD(exact_state[0], d_bond, dt, h=h_ev)
mps_state = mps.dense_evolution(time_steps)
